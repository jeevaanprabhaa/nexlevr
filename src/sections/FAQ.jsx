...
export default function FAQ() {
  ...
  return (
    <section id="faqs" style={{ background: '#f2ede4', padding: isMobile ? '80px 20px' : '120px 60px', borderTop: '2px solid rgba(13,13,13,0.08)' }}>
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        >
          <h2 style={{ fontSize: 'clamp(36px, 7vw, 80px)', fontWeight: 900, lineHeight: 0.92, letterSpacing: '-4px', color: '#0d0d0d' }}>
            got questions?{' '}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
          {faqs.map((faq, i) => (
            <motion.div
              ...
              style={{ borderTop: '2px solid rgba(13,13,13,0.1)', overflow: 'hidden' }}
            >
              <button
              ...
              >
                <span style={{ fontSize: isMobile ? 15 : 18, fontWeight: 700, color: '#0d0d0d', letterSpacing: '-0.4px', lineHeight: 1.3 }}>
                  {faq.q}
                </span>
                <motion.div
                  ...
                  style={{
                    ...
                    flexShrink: 0, color: open === i ? '#f2ede4' : '#0d0d0d',
              ...
              <AnimatePresence>
                {open === i && (
                  ...
                  >
                    <p style={{ paddingBottom: 24, fontSize: 14, color: 'rgba(13,13,13,0.6)', lineHeight: 1.75, maxWidth: 720 }}>
                      {faq.a}
                    </p>
                  </motion.div>
                )}
